import { ay as generateCspDigest, Z as spreadAttributes, aV as unescapeHTML, T as renderTemplate, aW as removeBase, aX as isRemotePath, A as AstroError, aY as UnknownContentCollectionError, aZ as AstroUserError, a8 as defineMiddleware, ah as sequence } from './chunks/sequence_ZbtXQtgf.mjs';
import 'piccolore';
import 'clsx';
import 'html-escaper';
import { Traverse } from 'neotraverse/modern';
import * as z from 'zod/v4';
import { c as createComponent, V as VALID_INPUT_FORMATS } from './chunks/consts_BlLaOhr6.mjs';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./chunks/_astro_data-layer-content_BrVaeu6W.mjs');
...
function createGetCollection({
  ...
  return async function getCollection(collection, filter) {
    ...
    if (store.hasCollection(collection)) {
      const { default: imageAssetMap } = await import('./chunks/content-assets_CDSNevsW.mjs');
      const result = [];
...
const starlightConfig = {"defaultLocale":{"label":"Tiếng Việt","lang":"vi","dir":"ltr"}};

const project = {"root":"file:///D:/THDD/docs/docs-site/","srcDir":"file:///D:/THDD/docs/docs-site/src/"};
